...
def check_play_button(
    ...
    if button_clicked and not stats.game_active:
        ...
        pygame.mouse.set_visible(False)  # Passing false makes pygame hide cursor
...
def check_bullet_alien_collisions(
    ...
    if len(aliens) == 0:  # check to see if alien group is empty
        # Idf the entire fleet is destroyed, start a new level
        bullets.empty()
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number):
    """Create n alien and place it in the row."""
...
def check_aliens_bottom(ai_settings, stats, screen, ship, aliens, bullets):
    """Check if any aliens have reached the bottomof the screen."""
